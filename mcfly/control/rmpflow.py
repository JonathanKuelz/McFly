...
class FrankaRMPFlowController(mg.MotionPolicyController):
    """Default Omniverse RMPFlowController.

    Args:
        name (str): Controller name
        robot_articulation (SingleArticulation): The articulation to be controlled.
