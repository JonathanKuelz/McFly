"""Inspired by isaacsim.examples.interactive.base_sample"""
import gc
...
class SimTemplate(ABC):
    """A simple base class that defines necessary and helpful methods for robotics extensions."""
